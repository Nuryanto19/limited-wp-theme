	...
	function limited_posted_on() {
		...
		$posted_on   = apply_filters(
			...
			sprintf(
				...
				esc_html_x( 'Updated:','post date', 'limited' ),
		...
		$byline      = apply_filters(
			'limited_posted_by',
			sprintf(
				'<div class="byline"><span class="author vcard"> %1$s <a class="url fn n" href="%2$s">%3$s</a></span></div>',
				$posted_on ? esc_html_x( 'Author:','post author', 'limited' ) : esc_html_x( 'Posted by','','post author', 'limited' ),
