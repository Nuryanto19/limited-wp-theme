...
if ( ! function_exists( 'limited_pagination' ) ) {
	/**
	 ...
	 */
	function limited_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'limited' ),
				'next_text'          => __( '&raquo;', 'limited' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'limited' ),
			)
		);
